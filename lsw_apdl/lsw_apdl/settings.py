"""
Django settings for lsw_apdl project.
...
WSGI_APPLICATION = "lsw_apdl.wsgi.application"
...
STATIC_URL = "static/"
STATICFILES_DIRS = [
    BASE_DIR / "static",  # if your static files are inside a /static folder at the root
]
